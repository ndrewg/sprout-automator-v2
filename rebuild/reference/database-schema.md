...
This is the complete, canonical Drizzle schema. **Reproduce `src/db/schema.ts` verbatim.** Then generate the migration from it (`npm run db:generate -- --name init`), review the SQL, and commit both.
